        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Address = table.Column<string>(type: "varchar(50)", fixedLength: true, maxLength: 50, nullable: false),
                    Gender = table.Column<int>(type: "int", fixedLength: true, nullable: false),
                    PhotoPath = table.Column<string>(type: "varchar(255)", fixedLength: true, nullable: true)
                },
                constraints: table =>
                {
